...
contract BOC_NFT_Premier is ERC721URIStorage, Ownable {
    ...
    address _artist,
    address _txFeeToken,
    uint _txFeeAmount) ERC721("Bank of Cronos Initial NFT Offering - Premier", "bocNFT_Premier")
    {
        tokenCounter = 0;
        artist = _artist;
    ...
    function create() public {
        ...
        string memory imageURI = 'ipfs://QmXZUuGrUCd7Yunrrzhy7znxicxJ6XW8AgXRoxxLRb8B6D';
                ...
                abi.encodePacked(
                    ...
                    Base64.encode(
                        bytes(
                            abi.encodePacked(
                                '{"name":"',
                                "Bank Of Cronos Initial NFT Offering - Premier", // You can add whatever name here
                                '", "description":"The Official Bank of Cronos Initial NFT Offering - Premier", "Edition":"',Strings.toString(_tokenCounter),'", "image":"',imageURI,'"}'
                            )
                        )
                    )
                )
