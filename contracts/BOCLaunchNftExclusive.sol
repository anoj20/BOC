...
contract BOC_NFT_Exclusive is ERC721URIStorage, Ownable {
    ...
    address _artist,
    address _txFeeToken,
    uint _txFeeAmount) ERC721("Bank of Cronos Initial NFT Offering - Exclusive", "bocNFT_Exclusive")
    {
        tokenCounter = 0;
        artist = _artist;
    ...
    function create() public {
        ...
        string memory imageURI = 'ipfs://QmThVHdD34UtidF1jhuwHKzEQPnATNxa7Epoi97TUfeAJo';
                ...
                abi.encodePacked(
                    ...
                    Base64.encode(
                        bytes(
                            abi.encodePacked(
                                '{"name":"',
                                "Bank Of Cronos Initial NFT Offering - Exclusive", // You can add whatever name here
                                '", "description":"The Official Bank of Cronos Initial NFT Offering - Exclusive", "Edition":"',Strings.toString(_tokenCounter),'", "image":"',imageURI,'"}'
                            )
                        )
                    )
                )
