...
async function main() {
    ...
    // import CronaswapRouter from './artifacts/contracts/CronaSwapRouter.sol/CronaSwapRouter.json'
     ...
     const OHMAddress = '0x83f5DBFE74465552800016c6921930cBc4064C84'
     const DAIAddress = '0x18642dC8B71a77E1a7A60Ad79dC264A1612F8917'
    ...
    const BOCMultiSigAddress = '0x29942051fFA466395a0a2E3Fa321f47b6ED4A000'
...
// // //     // // Deploy sOHM
     ...
     const sOHM = await SOHM.attach(SOHMAddress);
...
// // //     // // Deploy staking warmpup
     ...
     const stakingWarmup = await StakingWarmpup.attach(StakingWarmpupAddress);
...
// //     // @dev changed function call to Treasury of 'valueOf' to 'valueOfToken' in BondDepository due to change in Treausry contract
    ...
    const daiBond = await DAIBond.attach(DAIBondAddress);
...
// // //     // //@dev changed function call to Treasury of 'valueOf' to 'valueOfToken' in BondDepository due to change in Treausry contract
    ...
    const fraxBond = await FraxBond.attach(FraxBondAddress);
...
// //     // // Approve the treasury to spend DAI and Frax
     await dai.approve(treasury.address, '11300000000000' );
//     sleep(10000);
...
//     // // Deposit 9,000,000 DAI to treasury, 600,000 OHM gets minted to deployer and 8,400,000 are in treasury as excesss reserves
    await treasury.deposit('11300000000000', dai.address, '10057000000');
